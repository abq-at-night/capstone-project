			...
			<div class="panel-heading">
				<div class="h4 panel-title mb-2 mt-2">Create a new event.</div>
					...
					<div id="event-image" class="form-group required">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-image" name="event-image" placeholder="www.eventimageurl.com" type="text" />
						</div>
					</div>
						...
						<div id="event-title" class="form-group required">
							...
							<div class="controls">
								<input class="input-md textinput textInput form-control mb-1" id="event-title" name="event-title" placeholder="Enter a title." type="text" />
							</div>
						</div>
					...
					<div id="event-venue" class="form-group">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-venue" name="event-venue" placeholder="Enter a venue. (optional)" type="text" />
						</div>
					</div>
					...
					<div id="event-latitude" class="form-group">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-latitude" name="event-latitude" placeholder="BE CAREFUL! Only six digits are allowed after the decimal." type="text" />
						</div>
					</div>
					...
					<div id="event-longitude" class="form-group">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-longitude" name="event-longitude" placeholder="BE CAREFUL! Only six digits are allowed after the decimal." type="text" />
						</div>
					</div>
					...
					<div id="event-date-start-time" class="form-group required">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-date-start-time" name="event-date-start-time" placeholder="Y-M-D H:M:S" type="text" />
						</div>
					</div>
					...
					<div id="event-date-end-time" class="form-group required">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-date-end-time" name="event-date-end-time" placeholder="Y-M-D H:M:S" type="text" />
						</div>
					</div>
					...
					<div id="event-price" class="form-group">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-price" name="event-price" placeholder="Enter the price. (optional)" type="text" />
						</div>
					</div>
					...
					<div id="event-age-requirement" class="form-group">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-age-requirement" name="event-age-requirement" placeholder="Enter the age requirement. (optional)" type="text" />
						</div>
					</div>
						...
						<div id="event-description" class="form-group required">
							...
							<div class="controls">
								<input class="input-md textinput form-control mb-1" id="event-description" name="event-description" placeholder="Enter an event description." type="text" />
							</div>
						</div>
						...
						<div id="event-venue-website" class="form-group">
							...
							<div class="controls">
								<input class="input-md textinput textInput form-control mb-1" id="event-venue-website" name="event-venue-website" placeholder="www.eventvenue.com (optional)" type="text" />
							</div>
						</div>
					...
					<div id="event-promoter-website" class="form-group">
						...
						<div class="controls">
							<input class="input-md textinput textInput form-control mb-1" id="event-promoter-website" name="event-promoter-website" placeholder="www.promoterwebsite.com (optional)" type="text" />
						</div>
					</div>
